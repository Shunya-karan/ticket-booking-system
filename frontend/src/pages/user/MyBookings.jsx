                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button
                      ...
                      className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
                    >
